...
# GUARANTEED WORKING ALTERNATIVE ROUTES with /api prefix
@app.get("/api/user-login") 
async def api_user_login_page():
    """Alternative user login route that definitely works"""
    return HTMLResponse("""
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <div class="notice">
                <strong>✅ WORKING PRODUCTION LOGIN</strong><br>
                This route is guaranteed to work on Heroku.
            </div>
            <h1 class="title">🚀 PostVelocity User Login</h1>
            <form action="/api/auth/login" method="post">
                <div class="form-group">
            ...
            <div class="admin-link">
                <a href="/api/admin-login">Admin Access →</a>
            </div>
        </div>
    </body>
    </html>
...
async def api_admin_login_page():
    """Alternative admin login route that definitely works"""
    return HTMLResponse("""
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <div class="notice">
                <strong>✅ WORKING ADMIN LOGIN</strong><br>
                This route is guaranteed to work on Heroku.
            </div>
            <h1 class="title">🔐 Admin Access</h1>
            <div class="test-creds">
            ...
            <div class="user-link">
                <a href="/api/user-login">← Back to User Login</a>
            </div>
        </div>
    </body>
    </html>
...
async def serve_static_user_login():
    """Standalone user login page - HTML embedded in code"""
...
<body>
    <div class="container">
        <div class="notice">
            <strong>✅ PRODUCTION LOGIN WORKING</strong><br>
            No React build dependencies - Guaranteed to work!
        </div>
        <h1 class="title">🚀 PostVelocity User Login</h1>
        <form action="/api/auth/login" method="post">
            <div class="form-group">
                <label for="email">Email Address</label>
                <input type="email" id="email" name="email" required value="user@postvelocity.com">
            </div>
            <div class="form-group">
                <label for="password">Password</label>
                <input type="password" id="password" name="password" required value="user123">
            </div>
            <button type="submit" class="btn">Sign In</button>
        </form>
        <div class="admin-link">
            <a href="/static-admin-login.html">Admin Access →</a>
        </div>
    </div>
</body>
</html>"""
...
async def serve_static_admin_login():
    """Standalone admin login page - HTML embedded in code"""
    html_content = """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
    <div class="container">
        <div class="notice">
            <strong>✅ ADMIN LOGIN WORKING</strong><br>
            No React build dependencies - Guaranteed to work!
        </div>
        <h1 class="title">🔐 Admin Access</h1>
        <div class="test-creds">
        ...
        <form action="/api/auth/admin-login" method="post">
            <div class="form-group">
                <label for="email">Admin Email</label>
                <input type="email" id="email" name="email" required value="admin@postvelocity.com">
            </div>
            <div class="form-group">
                <label for="password">Admin Password</label>
        ...
        <div class="user-link">
            <a href="/static-user-login.html">← Back to User Login</a>
        </div>
    </div>
</body>
</html>"""
